...
pub fn hidden_layer(allocator: *std.mem.Allocator, size: u32, prev_size: u32) !TYPES_LAYER.Layer {
	var hidden_layers = std.ArrayList(TYPES_LAYER.Neuron).init(allocator.*);
	...
	for(0..size) |_| {
		...
		try hidden_layers.append(neuron);
	}
